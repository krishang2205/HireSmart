...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-blue-50 to-indigo-50 border-r border-blue-200 flex flex-col shadow-lg min-h-full relative">
      {/* Logo/Brand Section */}
            ...
            return (
              ...
              >
                ...
                <span className={`font-medium transition-all duration-200 ${
                  active ? 'text-white' : 'text-gray-700 group-hover:text-indigo-700'
                }`}>
                  {item.label}
                </span>
                ...
                {/* Hover effect */}
                {!active && (
                  <div className="absolute inset-0 bg-gradient-to-r from-indigo-50 to-blue-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-xl"></div>
                )}
              </a>
            );
          })}
